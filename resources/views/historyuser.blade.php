...
@section('content')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item" id="notcolor"><a href="{{ route('userdetail', ['id' => $finduser->id]) }}">รายละเอียด</a>
        </li>
        <li class="breadcrumb-item" id="now"><a href="">ประวัติขอใบอนุมัติ</a></li>
    </ol>
    ...
    @if ($data->isEmpty())
        <div class="alert-info">
            <p><img src="{{ asset('images/history.png') }}" alt="Success Image" width="50ox" height="50px">
                {{ $finduser->prefix }}{{ $finduser->name }} {{ $finduser->lname }} ไม่มีประวัติการขอใบอนุมัติการเดินทาง</p>
        </div>
    @else
